...
--
-- Host: 127.0.0.1    Database: u159062377_news
-- ------------------------------------------------------
...
INSERT INTO `hr_app_modulo` VALUES (16,'Usuario','2016-06-01 00:00:00','2018-06-01 00:00:00','dbo','2016-07-30 20:34:26',NULL,NULL),(19,'Modulo','2016-06-01 00:00:00','2018-06-01 00:00:00','dbo','2016-07-30 20:34:40',NULL,NULL),(21,'Perfil','2016-06-01 00:00:00','2018-06-01 00:00:00','dbo','2016-07-30 20:34:40',NULL,NULL),(22,'PerfilModulo','2016-06-01 00:00:00','2018-06-01 00:00:00','dbo','2016-07-30 20:34:40','Test','2016-09-26 00:51:54'),(23,'Menu','2016-01-01 00:00:00','2050-01-01 00:00:00','test','2016-09-28 04:41:12',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='Perfiles de seguridad';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hr_app_perfil` VALUES (1,'Administrador','2016-06-01 00:00:00','2020-06-01 00:00:00','-1','2016-06-01 21:23:41',NULL,NULL),(22,'usuario','2016-01-01 00:00:00','2018-01-01 00:00:00','test','2016-09-28 04:14:11',NULL,NULL),(23,'nada','2016-01-01 00:00:00','2020-01-01 00:00:00','test','2016-09-28 04:29:20',NULL,NULL);
...
INSERT INTO `hr_app_session_keys` VALUES ('4b6084ec-2b6e-11e6-a94e-c04a00011902',2,'2016-06-05 20:09:04','2016-06-06 01:39:04'),('8084d8c4-2b79-11e6-a94e-c04a00011902',2,'2016-06-05 21:29:18','2016-06-06 02:59:18'),('a223e322-3657-11e6-a49b-c04a00011902',2,'2050-01-01 00:00:00','2016-06-19 22:54:29'),('02a89193-3b17-11e6-a1f2-c04a00011902',2,'2016-06-25 18:24:29','2016-06-25 23:54:29'),('1f221745-8519-11e6-a581-c04a00011902',4,'2016-09-27 22:46:02','2016-09-28 04:16:02'),('4b9cac7f-851c-11e6-a581-c04a00011902',5,'2016-09-27 23:08:45','2016-09-28 04:38:45');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`u159062377_user`@`127.0.0.1`*/ /*!50003 TRIGGER before_insert_session_keys
...
--
-- Dumping events for database 'u159062377_news'
--

--
-- Dumping routines for database 'u159062377_news'
--
...
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` FUNCTION `getErrorMessage`(pLang varchar(2),pValue varchar(5)) RETURNS varchar(1024) CHARSET utf8
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` FUNCTION `getMenuId`(pName varchar(128)) RETURNS int(11)
BEGIN
		DECLARE  vId INT;
        SELECT a.id_menu
			INTO vId
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` FUNCTION `getParamValue`(pParamName varchar(50)) RETURNS varchar(500) CHARSET utf8
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` FUNCTION `raiseError`(pLang varchar(2),pValue varchar(5)) RETURNS varchar(1024) CHARSET utf8
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `clientDelete`(pk int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `clientGetAll`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `clientInsert`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `clientUpdate`(
	pId_Cliente int,
	pNombre varchar(500),
	pCodigo varchar(25),
	pHabilitado tinyint,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `getErrorMessage`(pLang varchar(2),pValue varchar(5))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `getSessionkeysByUUID`(pUuid varchar(64))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `menu_addNodeChild`(pId_menu int,pLang varchar(2),pName varchar(128))
BEGIN
		DECLARE myLeft INT;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `menu_addNodeSameLevel`(pId_menu int,pLang varchar(2),pName varchar(128))
BEGIN
		DECLARE vErrorMessage varchar(1024);
        DECLARE myRight INT;
        DECLARE id INT;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `menu_deleteNode`(pId_menu int)
BEGIN
		DECLARE vCount INT;
        DECLARE myLeft INT;
        DECLARE myRight INT;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `menu_deleteNodeMoveChild`(pId_menu int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `menu_getAll`(pLang varchar(2))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `menu_getAllLeafNodes`(pLang varchar(2))
BEGIN
		SELECT c.menu_text
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `menu_getDepthSubTree`(id int,pLang varchar(2))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `menu_getFullTree`(id int,pLang varchar(2))
BEGIN
		SELECT c.menu_text
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `menu_getImmediateSubordinatesNode`(id int,pLang varchar(2))
BEGIN
    	SELECT c.menu_text, (COUNT(parent.id_menu) - (sub_tree.depth + 1)) AS depth
		FROM hr_menu AS node,
			hr_menu AS parent,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `menu_getNodesDepth`(pLang varchar(2))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `menu_List`(pLang varchar(2))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `moduloDelete`(pk int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `moduloGetAll`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `moduloGetById`(pk int)
BEGIN
    select id_modulo,modulo,vigencia_desde,vigencia_hasta,creado_por,modificado_por
    from hr_app_modulo
    where id_modulo=pk;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `moduloInsert`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `moduloUpdate`(
	pId_Modulo int,
	pModulo varchar(100),
	pVigencia_Desde datetime,
	pVigencia_Hasta datetime,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilDelete`(pk int)
BEGIN
	DECLARE vErrorMessage varchar(1024);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilGetAll`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilGetById`(pk int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilInsert`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilmoduloDelete`(pk int)
BEGIN
    delete from hr_app_perfil_modulo
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilmoduloGetAll`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilmoduloGetByModuloUsuario`(pModulo varchar(100),pIdUsuario int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilmoduloInsert`(
	pId_Perfil int ,
	pId_Modulo int ,
	pEnabled int,
	pCreado_Por varchar(20)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilmoduloUpdate`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `perfilUpdate`(
	pId_Perfil int,
	pPerfil varchar(50),
	pVigencia_Desde datetime,
	pVigencia_Hasta datetime,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `sessionkeysGetAll`()
BEGIN
    select uuid,id_usuario,expiration,created
    from hr_app_session_keys;
END ;;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `usuarioDelete`(pk int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `usuarioGetAll`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `usuarioInsert`(
	pUsuario varchar(50),
	pNombre varchar(50),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1` PROCEDURE `usuarioUpdate`(
	pId_Usuario int,
	pUsuario varchar(50),
	pNombre varchar(50),
	pApellido varchar(50),
...
-- Dump completed on 2019-11-10 21:09:32
