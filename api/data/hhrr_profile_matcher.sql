...
INSERT INTO `hr_app_perfil_modulo` VALUES (22,1,21,1,'test','2018-06-01 03:00:00','test','2016-09-26 04:27:24'),(23,1,19,1,'test','2018-06-01 03:00:00','test','2016-09-26 04:27:27'),(25,1,16,1,'test','2018-06-01 03:00:00','test','2016-09-26 04:44:30'),(26,1,22,1,'test','2018-06-01 03:00:00','test','2016-09-26 04:27:48'),(36,22,16,1,'test','2016-09-28 01:14:48',NULL,NULL),(37,22,22,0,'test','2016-09-28 01:27:05','test','2016-09-28 01:27:50'),(38,1,23,1,'test','2016-10-09 19:04:14',NULL,NULL);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1`  PROCEDURE `clienteDelete`(pk int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1`  PROCEDURE `clienteGetAll`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1`  PROCEDURE `clienteGetById`(pk int)
BEGIN
    select id_cliente,nombre,codigo,habilitado,creado_por,fecha_modificacion,modificado_por,fecha_creacion 
    from hr_cliente
    where id_cliente=pk;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`u159062377_user`@`127.0.0.1`  PROCEDURE `clienteInsert`(
...
-- Dump completed on 2017-08-05 20:21:10
